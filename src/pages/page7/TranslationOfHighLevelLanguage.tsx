...
const sumList = data ? data.sum as string[][] : [];
const formulaList = data ? data.formula as string[][] : [];
const infiniteLoopList = data ? data.infiniteLoop as string[][] : [];
const ifThenElseList = data ? data.ifThenElse as string[][] : [];
const whileList = data ? data.while as string[][] : [];
const forLoopList = data ? data.forLoop as string[][] : [];
