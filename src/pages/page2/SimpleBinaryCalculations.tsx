...
const Page2 = () => {
    ...
    useEffect(() => {
    if (data) {
        setFooterData(data.references || []); // Set footer data only when data is available
    }
    }, [data, setFooterData]);
    ...
    const textTable = data ? data.textTable : [];
    const instructionTable = data ? data.instructionTable : [];
        ...
        <Section>
            <InlineDivs centerStart containsTable>
                ...
                <MaxWidthContainer smallPadding>
                    <Table headerTitles={['Binary', 'Char', 'Binary', 'Char'] } bodyRows={textTable as string[][]} />
            ...
            <InlineDivs centerStart isEven>
                <MaxWidthContainer smallPadding>
                    <Table headerTitles={['binary Code', 'description'] } bodyRows={instructionTable as string[][]} />
                    <Description isDark>
